...
?>
        ...
        <?php
          ...
          else
          {
            ...
            $tongtatca_chieu+=$tong_chieu;
            $tongtatca_tong+=$tong;
            $sql= mysql_query("SELECT kiemtrachinh.ms,hoten,thoigian FROM kiemtrachinh INNER JOIN nhanvien ON kiemtrachinh.ms=nhanvien.ms WHERE thoigian >= '$start 11:00:00' AND thoigian <= '$start 20:59:00' ORDER BY thoigian asc" );
