...
?>
        <p style="text-align: right;float: left;"><input type="button" id="export"  value="XUẤT EXCEL" style="margin-top: 30px" class="btn btn-primary"></p>
        ...
        <?php
          ...
          else
          {
            ...
            <thead>
              <tr>
                <td width="100" bgcolor="#999999"><strong>NGÀY</strong></td>
                <td width="150" bgcolor="#999999"><strong>SỐ LƯỢNG</strong></td>
                <td width="375" bgcolor="#999999"><strong>CHI TIẾT</strong></td>
              </tr>
            </thead>
            <tbody>
            <?php
          ...
          ?>
              <tr>
                  <td>&nbsp;<?php echo "<p>$start</p>";?></td>
                  <td>&nbsp;<?php echo"- Sáng:<br> + Nhân viên: $tongnhanvien_sang <br> + Khách: $tongkhach_sang <br> + Sinh viên: $tongsinhvien_sang<br> - Chiều: <br> + Nhân viên: $tongnhanvien_chieu<br> + Khách: $tongkhach_chieu<br> + Sinh viên: $tongsinhvien_chieu <br> - Tổng tất cả: $tong";?></td>
              <td>
                  <table>
              <?php
                $buoi_previus= "";
                ...
                while($array=mysql_fetch_array($sql))
                {
                 ...
                 if ($tong_chieu!=0)
                 echo"<tr><td colspan='4' style='color:red;font-weight:bold;font-size:20px'>TỔNG CHIỀU: $tong_chieu</td></tr>";
                 ?>
                 </table>
                 </td>
              </tr>
 ...
 $(document).ready(function()
         {
            $("#export").click(function(){
                ...
                var start = $("#start").val();
                var end = $("#end").val();
                $.post("report_ajax_excel.php", {select_time:select_time,dongy:1,select_mode:select_mode,start:start,end:end}, function(data){$("#display1").html(data);})
            })
            })
</script>
