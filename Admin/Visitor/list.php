                  ...
                  <?php
                   //nut show all dc nhan
                    if(isset($_POST['show']))
                    {
                      ...
                      <!-- xu ly query php -->
                      <?php
                        $sql="SELECT * FROM nhanvien where dep is null and maloai='2'";
                      ...
                      <tr>
                        ...
                        <td style="width: 15%;text-align: center;"> Khách hàng </td>
                        <td style="width: 20%;text-align: center;"> <?php echo $array['tentochuc'] ?> </td>
                        <td style="width: 15%;text-align: center;"> <?php echo $array['start'] ?> </td>
                        <td style="width: 15%;text-align: center;"> <?php echo $array['finish'] ?> </td>
                      </tr>
                      <!-- xong phan td -->
                      <?php
                        }
                    ...
                    {
                      $sort=$_POST['sort'];
                      $tb=mysql_query("SELECT * From nhanvien where ((ms like '%$sort%' or hoten like '%$sort%' or dep like '%$sort%' or subdep like '%$sort%') and dep is null and maloai='2')");
                      ?>
                      <!-- hien thi table html -->
                        <table class="w3-table-all">
                          <tr>
