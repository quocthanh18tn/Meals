...
?>
        ...
        <?php
          ...
          else
          {
            ...
            $sql5 = mysql_query("SELECT kiemtrachinh.ms,hoten,thoigian FROM kiemtrachinh INNER JOIN nhanvien ON kiemtrachinh.ms=nhanvien.ms WHERE thoigian >= '$start 11:00:00' AND thoigian <= '$start 13:00:00'");
            $tong_sang = mysql_num_rows($sql5);
            $sql6 = mysql_query("SELECT kiemtrachinh.ms,hoten,thoigian FROM kiemtrachinh INNER JOIN nhanvien ON kiemtrachinh.ms=nhanvien.ms WHERE thoigian >= '$start 16:00:00' AND thoigian <= '$start 18:00:00'");
          ...
          ?>
              ...
              <?php
                ...
                while($array=mysql_fetch_array($sql5))
                {
                  ?>
                  <tr>
                  <td>
                 ...
                 while($array=mysql_fetch_array($sql6))
                {
                  ?>
                  <tr>
                  <td>
