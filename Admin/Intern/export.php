...
if(isset($_POST['button1']))
{
  ...
  $sql=mysql_query("SELECT ms,hoten,tentochuc from nhanvien where ms like 'S%'");
...
?>
 ...
 <form method="post" action="">
 				<br>
 				<br>
                <p style="text-align: center;font-size: 25px;font-weight: bold;">Xuất thông tin sinh viên</p>
