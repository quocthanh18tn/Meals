...
<head>
  ...
  <title>CĂN TEEN HAI NAM AUTOMATION</title>
...
<div style="background-color: lightblue;">
  ...
  <div class="fakeimg1 text-center" >
    ...
    <form name="form1" method="post" action="checklogin_administration.php">
...
<div class="container">
  <div class="login-container">
            ...
            <div class="form-box">
                    <input name="ID" type="text" placeholder="tên đăng nhập">
                    <input type="password" name="password" placeholder="mật khẩu">
                    <button class="btn btn-info btn-block login" name="Submit" type="submit">Login</button>
            </div>
            <br>
            <a href="../doimatkhau/doimatkhau.php" style="color: red">Nhấn vào đây nếu bạn muốn đổi mật khẩu!!!</a>
